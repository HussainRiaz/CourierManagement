	...
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="" class="control-label">Your Account Email Address</label>
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			...
  			<a class="btn btn-flat bg-gradient-secondary mx-2" href="./Dashboard.php?page=parcel_list">Cancel</a>
  		</div>
  	</div>
	</div>
</div>

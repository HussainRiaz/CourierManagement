	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./Dashboard.php?page=new_parcel"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$query = "SELECT * from parcels $where order by  unix_timestamp(date_created) desc";
					...
					<tr>
						...
						<td class="text-center">
							...
							<?php if($_SESSION['login_type'] == 1): ?>
		                        <a href="Dashboard.php?page=edit_parcel&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-flat ">
